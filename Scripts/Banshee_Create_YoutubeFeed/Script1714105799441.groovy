...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Youtube Feed')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Youtube Feeds')

WebUI.click(findTestObject('CreateFeed/Dropdown_Reddit'))

WebUI.click(findTestObject('CreateFeed/Dropdown_YouTube'))

WebUI.setText(findTestObject('CreateFeed/textarea_concat(Select , , Copy channel ID,_bbc41f'), 'UCoyaxd5LQSuP4ChkxK0pnZQ')
...
WebUI.verifyTextPresent('Gabor\'s Autotest Youtube Feed', false)

WebUI.verifyTextPresent('Testing Automated Youtube Feeds', false)
