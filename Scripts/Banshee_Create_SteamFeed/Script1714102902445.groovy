...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Steam Feed')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Steam Feeds')

WebUI.click(findTestObject('CreateFeed/Dropdown_Reddit'))

WebUI.click(findTestObject('CreateFeed/Dropdown_Steam'))

WebUI.setText(findTestObject('CreateFeed/Box_AddSteamAppID'), '1774580')

WebUI.setText(findTestObject('CreateFeed/Box_Query'), '"GOOD" OR "FUN" OR "BAD" OR "EA" OR "COOL"')

WebUI.click(findTestObject('CreateFeed/button_SteamLanguage'))

WebUI.click(findTestObject('CreateFeed/button_AllSteamLanguages'))
...
WebUI.verifyTextPresent('Gabor\'s Autotest Steam Feed', false)

WebUI.verifyTextPresent('Testing Automated Steam Feeds', false)
