...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest AHQ Feed'))
...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest AHQ Feed Edited')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated AHQ Feeds Edited')

WebUI.click(findTestObject('Page_Gabors New Project/button_Submit'))

WebUI.waitForPageLoad(500)

WebUI.verifyTextPresent('Gabor\'s Autotest AHQ Feed Edited', false)
