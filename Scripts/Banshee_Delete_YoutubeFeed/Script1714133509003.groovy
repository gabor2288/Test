...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Youtube Feed Edited'))
...
WebUI.verifyTextPresent('Gabor\'s Autotest Youtube Feed Edited (Deleting)', false)
