...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Steam Feed Edited'))
...
WebUI.verifyTextPresent('Gabor\'s Autotest Steam Feed Edited (Deleting)', false)
