...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Discord Feed')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Discord Feeds')

WebUI.click(findTestObject('CreateFeed/Dropdown_Reddit'))

WebUI.click(findTestObject('CreateFeed/Dropdown_Discord'))

WebUI.setText(findTestObject('CreateFeed/textarea_Finalizing the Configuration_AppsI_499cb1'), '771078623430967317')
...
WebUI.verifyTextPresent('Gabor\'s Autotest Discord Feed', false)

WebUI.verifyTextPresent('Testing Automated Discord Feeds', false)
