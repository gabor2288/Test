...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Appstore Feed Edited'))
...
WebUI.verifyTextPresent('Gabor\'s Autotest Appstore Feed Edited (Deleting)', false)
