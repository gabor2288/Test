...
WebUI.openBrowser('https://stage.banshee.ea.com/login')

WebUI.setText(findTestObject('LoginPage_Banshee/Box_User_email'), 'ghgghpetras@ea.com')
...
WebUI.setEncryptedText(findTestObject('LoginPage_Banshee/Box_Password'), 'e7qiUFDz2ewltSet7yL9Ww==')
