...
WebUI.click(findTestObject('DarkLightMode_Banshee/button_DarkMode'))

WebUI.verifyElementInViewport(findTestObject('DarkLightMode_Banshee/button_LightMode'), 1)

WebUI.click(findTestObject('DarkLightMode_Banshee/button_LightMode'))
