...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Steam Feed'))
...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Steam Feed Edited')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Steam Feeds Edited')

WebUI.click(findTestObject('Page_Gabors New Project/button_Submit'))

WebUI.waitForPageLoad(400)

WebUI.verifyTextPresent('Gabor\'s Autotest Steam Feed Edited', false)
