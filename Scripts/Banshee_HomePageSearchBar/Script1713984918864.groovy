...
WebUI.setText(findTestObject('BansheeHomePage/Box_Home_FieldSearch'), 'SONAR')

WebUI.verifyTextPresent('SONAR: LoTR', false)

WebUI.verifyTextPresent('SONAR - Public', false)
