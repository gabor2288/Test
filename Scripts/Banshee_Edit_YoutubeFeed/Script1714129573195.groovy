...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Youtube Feed'))
...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Youtube Feed Edited')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Youtube Feeds Edited')

WebUI.click(findTestObject('Page_Gabors New Project/button_Submit'))

WebUI.verifyTextPresent('Gabor\'s Autotest Youtube Feed Edited', false)
