...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Discord Feed'))
...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Discord Feed Edited')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Discord Feeds Edited')

WebUI.click(findTestObject('Page_Gabors New Project/button_Submit'))

WebUI.waitForPageLoad(100)

WebUI.verifyTextPresent('Gabor\'s Autotest Discord Feed Edited', false)
