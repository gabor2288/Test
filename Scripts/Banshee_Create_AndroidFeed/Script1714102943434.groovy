...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Android Feed')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Android Feeds')

WebUI.click(findTestObject('CreateFeed/Dropdown_Reddit'))

WebUI.click(findTestObject('CreateFeed/Dropdown_Android'))

WebUI.setText(findTestObject('CreateFeed/Box_AddGoogleAppID'), 'com.ea.game.pvzfree_row')
...
WebUI.verifyTextPresent('Gabor\'s Autotest Android Feed', false)

WebUI.verifyTextPresent('Testing Automated Android Feeds', false)
