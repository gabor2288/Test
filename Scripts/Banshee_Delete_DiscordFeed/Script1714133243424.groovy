...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Discord Feed Edited'))
...
WebUI.verifyTextPresent('Gabor\'s Autotest Discord Feed Edited (Deleting)', false)
