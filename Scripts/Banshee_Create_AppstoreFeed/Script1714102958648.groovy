...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Appstore Feed')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Appstore Feeds')

WebUI.click(findTestObject('CreateFeed/Dropdown_Reddit'))

WebUI.click(findTestObject('CreateFeed/Dropdown_AppStore'))

WebUI.setText(findTestObject('CreateFeed/Box_AddAppleAppStoreID'), '1512265589')
...
WebUI.verifyTextPresent('Gabor\'s Autotest Appstore Feed', false)

WebUI.verifyTextPresent('Testing Automated Appstore Feeds', false)
