...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest AHQ Feed Edited'))
...
WebUI.verifyTextPresent('Gabor\'s Autotest AHQ Feed Edited (Deleting)', false)
