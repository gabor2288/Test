...
WebUI.click(findTestObject('Page_Gabors New Project/Feed_Gabors Autotest Appstore Feed'))
...
WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s name.)'), 'Gabor\'s Autotest Appstore Feed Edited')

WebUI.setText(findTestObject('CreateFeed/Box_(Feed, , s description.)'), 'Testing Automated Appstore Feeds Edited')

WebUI.click(findTestObject('Page_Gabors New Project/button_Submit'))

WebUI.waitForPageLoad(70)

WebUI.verifyTextPresent('Gabor\'s Autotest Appstore Feed Edited', false)
